...
\begin{itemize}
    ...
    \item Mass ratios of 1:\input{tex_text/mass_ratio_8_to_8p5gyr_ago} around $8-8.5\,\mathrm{Gyr}$. Stellar masses at that time are \input{tex_text/mass_seq2_8_to_8p5gyr_ago.tex}$\times10^9\,\mathrm{M_\odot}$ and \input{tex_text/mass_seq1_8_to_8p5gyr_ago.tex}$\times10^9\,\mathrm{M_\odot}$
...
\begin{itemize}
    ...
    \item When testing the significance of separations of sequences in the age-[X/H] plane, we see the largest separations for the youngest accreted stars, even at larger observational noise (Fig.~\ref{fig:r12_for_sigmaobs} and Tab.~\ref{tab:tabular_separation_r12_noise}). We find that we loose the ability to tell sequences apart beyond 2-sigma for observational noise above $0.15\,\mathrm{dex}$ (Fig.~\ref{fig:r12_for_sigmaobs}) and age uncertainties above $25\%$ (Fig.~\ref{fig:age_sigma_vs_r}).
