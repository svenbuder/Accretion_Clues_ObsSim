...
L. Mijnarends,$^{1,2}$\thanks{E-mail: u6956623@anu.edu.au}
S. Buder,$^{1,2}$
T. Buck,$^{3,4,5}$
\\
...
\begin{figure*}
	\includegraphics[width=\textwidth]{figures/low_alpha_halo_convex_hull.png}
    \caption{
