...
\begin{figure*}
    ...
    \caption{
    \textbf{Major Caption.} Minor Caption.}
    \label{fig:r12_for_sigmaobs}
\end{figure*}


\begin{figure}
	\includegraphics[width=\columnwidth]{figures/accretion_rate.pdf}
    \caption{
    \textbf{Major Caption.} Minor Caption. Compare to \citet{Martig2021}.}
