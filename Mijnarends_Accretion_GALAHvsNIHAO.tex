...
\begin{table*}
    \centering
    \caption{\textbf{Separation significance $r_{12}$ (Eq.~\ref{eq:r_value}) between Sequence 1 and 2 in {[X/H]} of the Milky Way analogue for different age bins.} Values are calculated for the observable footprint without observational noise.}
