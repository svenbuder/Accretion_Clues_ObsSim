...
\SB{IMPORTANT ADJUSTMENT: SHIFTING MEDIAN([X/H]) TO 0.0 FOR STARS WITH 4-5 GYR!!! In particular, we shift the individual abundances by the median abundance [X/H] of stars between 4-5 Gyr by \input{tex_text/shift_by_4_to_5_gyr_median.tex}.}
...
\begin{figure*}
	\includegraphics[width=0.16\textwidth]{figures/age_xfe_xh_nxh_for_C.png}
	\includegraphics[width=0.16\textwidth]{figures/age_xfe_xh_nxh_for_O.png}
	\includegraphics[width=0.16\textwidth]{figures/age_xfe_xh_nxh_for_Mg.png}
	\includegraphics[width=0.16\textwidth]{figures/age_xfe_xh_nxh_for_Al.png}
	\includegraphics[width=0.16\textwidth]{figures/age_xfe_xh_nxh_for_Mn.png}
	\includegraphics[width=0.16\textwidth]{figures/age_xfe_xh_nxh_for_Ba.png}
    \caption{
    \textbf{Main text
    } Minor Text
    }
