...
\begin{figure*}
	\includegraphics[width=0.166\textwidth]{figures/age_xfe_xh_nxh_for_C.pdf}
	\includegraphics[width=0.166\textwidth]{figures/age_xfe_xh_nxh_for_O.pdf}
	\includegraphics[width=0.166\textwidth]{figures/age_xfe_xh_nxh_for_Mg.pdf}
	\includegraphics[width=0.166\textwidth]{figures/age_xfe_xh_nxh_for_Al.pdf}
	\includegraphics[width=0.166\textwidth]{figures/age_xfe_xh_nxh_for_Mn.pdf}
	\includegraphics[width=0.166\textwidth]{figures/age_xfe_xh_nxh_for_Ba.pdf}
    \caption{
    \textbf{Main text
    } Minor Text
    }
