...
In the absence of age uncertainties, we would expect to tell apart Sequence 1 and 2 by $2\sigma$ for $\sigma_\mathrm{obs} < 0.15\,\mathrm{dex}$ (Fig.~\ref{fig:r12_for_sigmaobs}, bottom row).



\textbf{Key Takeaway:} The intrinsic scatter in {[X/H]} is larger ($\sim 0.1-0.4\,\mathrm{dex}$) for older stars as a result of larger change in this logarithmic scale when compared to youngest stars ($\sim 0.02-0.05\,\mathrm{dex}$). This can also be seen in the top rows of Fig.~\ref{fig:r12_for_sigmaobs}. 
