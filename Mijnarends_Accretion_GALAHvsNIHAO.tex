...
Given the various abundance distributions in the [Fe/H] vs. [X/Fe] space from Fig.~\ref{fig:FeH_XFe}, we are now interested in the trends for different elements with age. Given the previous suggestions that not necessarily [X/Fe], but even [X/H] may be a better tracer of accreted stars \citep[e.g.][for [Mg/H]{Feuillet2021}, we are testing both age-[X/Fe] and age-[X/H] relations.

\subsubsection{Age-[X/Fe] or age-[X/H]?}
...
\subsubsection{Age-[X/H] or Age-$N_X$?}
